========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: FRAMEWORKVISIONORDENADOR Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL FRAMEWORKVISIONORDENADOR.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación FRAMEWORKVISIONORDENADOR.

FRAMEWORKVISIONORDENADOR.vcxproj
...
FRAMEWORKVISIONORDENADOR.vcxproj.filters
...
FRAMEWORKVISIONORDENADOR.cpp
    Este es el archivo de código fuente DLL principal.

FRAMEWORKVISIONORDENADOR.h
